  ...
  const testimonials = [
    {
      ...
      title: "Seller",
      quote:
        "I had an amazing experience at Delicious Bites! The flavors were exquisite and the presentation was top-notch. I particularly loved their signature dish, the truffle-infused risotto.",
    },
    {
      avatar: "https://randomuser.me/api/portraits/men/46.jpg",
      name: "Simon andrew",
      title: "Owner of Foodey",
      quote:
        "Taco Fiesta is a hidden gem! The tacos were bursting with flavor and freshness. I tried their carne asada and shrimp tacos, and both were exceptional. The meat was so tender and tasty.",
    },
    {
      ...
      title: "Owner of KFC",
      quote:
        "Baker's Haven is my go-to spot for a morning pick-me-up. Their pastries are divine! The croissants are buttery and flaky, and the muffins are moist and flavorful. The barista also whipped up a perfect cappuccino.",
    },
  ];

  return (
    <section className="relative py-24 bg-[#FAEAFE]">
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl sm:text-center md:mx-auto">
          ...
          <p className="mt-3 text-gray-600 text-center">
            Here from our customers and sellers. They are really happy to work
            with us. From their review and advise we imporve ourself futher
            more. Let&apos;s see their sweet review.
          </p>
        </div>
        <Marquee>
          <div className="mt-12">
            <ul className="flex">
              {testimonials.map((item, idx) => (
                <li
                  key={idx}
                  className="bg-white rounded-xl overflow-hidden border shadow-md w-[400px] mx-5"
                >
                  <div className="p-4">
                    <svg
