...
const Signup = () => {
  ...
  const handleSignUp = (e) => {
    ...
    const registerUserData = { username, photourl, email, password };

    fetch("https://slice-restaurant-server.vercel.app/registerUser", {
      method: "POST",
      headers: {
  ...
  return (
    <section>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Slice - Sign Up</title>
        <link rel="canonical" href="http://mysite.com/example" />
      </Helmet>
      <div className="lg:w-[1000px]  my-20 px-5 lg:px-10 py-10 xl:max-w-screen-xl lg:mx-auto grid lg:grid-cols-2 gap-5 lg:gap-10 items-center">
        <div className="w-full min-[600px]:w-[400px] min-[600px]:mx-auto">
          <img src="https://i.ibb.co/6XzyH7x/6368592.jpg" alt="sign up" />
        </div>
        <form
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            <input
              ...
              className="border-2 border-gray-700 w-full py-4 px-4 rounded-lg text-lg focus:outline-none"
              required
            />
            <input
            ...
            <div className="flex flex-col">
              <input
                ...
                } border-2 border-gray-700 py-4 px-4 w-full rounded-lg text-lg focus:outline-none`}
                type="email"
