...
const UserOrder = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://slice-restaurant-server.vercel.app/orderData?userEmail=${user?.email}`
      )
      .then((res) => {
      ...
      <div>
        <div className="relative flex justify-center h-[250px]">
          <img
            ...
            src="https://i.ibb.co/C1H8ckD/photo-1481437156560-3205f6a55735-q-80-w-1000-auto-format-fit-crop-ixlib-rb-4-0.jpg"
            alt=""
          />
